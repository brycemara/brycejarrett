        ...
        <div className="relative text-gray-700 antialiased text-sm font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-center">
              ...
              <div className="rounded-full w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                ...
                >
                  <g>
                    <g>
                      <path d="M343.415,149.854c-29.063,0-57.148,13.874-58.328,14.466l16.754,33.507c0.211-0.105,21.58-10.51,41.574-10.51    c20.07,0,41.4,10.425,41.613,10.53l16.715-33.527C400.563,163.728,372.478,149.854,343.415,149.854z" />
                    </g>
                  </g>
                  <g>
                    <g>
                      <path d="M168.585,149.854c-29.063,0-57.147,13.874-58.328,14.466l16.754,33.507c0.211-0.105,21.58-10.51,41.574-10.51    c20.07,0,41.4,10.425,41.613,10.53l16.715-33.527C225.732,163.728,197.648,149.854,168.585,149.854z" />
                    </g>
                  </g>
                  <g>
                    <g>
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              ...
              <div className="rounded-full bg-black w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="800px"
                  height="800px"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              {/* <div className="flex justify-start w-full mx-auto items-center"> */}
              <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                <p className="p-4 text-white rounded shadow">Egypt</p>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">Japan</div>
                </div>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
