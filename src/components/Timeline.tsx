export default function Timeline() {
  return (
    <div className="w-full py-6 flex flex-col justify-center sm:py-12">
      <div className="py-3 sm:max-w-[75%] sm:mx-auto w-full px-2 sm:px-0">
        <div className="relative text-gray-700 antialiased text-sm font-semibold">
          <h1 className="p-4 text-2xl text-center">Timeline</h1>
          <div className="hidden sm:block w-1 bg-dark-blue absolute h-full left-1/2 transform -translate-x-1/2"></div>
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="rounded-full bg-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center"></div>
            </div>
          </div>
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <p className="p-4 text-white rounded shadow">
                    Graduated Magna Cum Lade from Texas Tech University - Wreck
                    Em!
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    COVID, learned how to code
                  </div>
                </div>
              </div>
              <div
                style={{ backgroundColor: "#eff3f6" }}
                className="rounded-full bg-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="400px"
                  ...
                  <g>
                    <g>
                      <path
                        ...
                        d="M343.415,149.854c-29.063,0-57.148,13.874-58.328,14.466l16.754,33.507c0.211-0.105,21.58-10.51,41.574-10.51    c20.07,0,41.4,10.425,41.613,10.53l16.715-33.527C400.563,163.728,372.478,149.854,343.415,149.854z"
                      />
                    </g>
                  </g>
                  <g>
                    <g>
                      <path
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        d="M168.585,149.854c-29.063,0-57.147,13.874-58.328,14.466l16.754,33.507c0.211-0.105,21.58-10.51,41.574-10.51    c20.07,0,41.4,10.425,41.613,10.53l16.715-33.527C225.732,163.728,197.648,149.854,168.585,149.854z"
                      />
                    </g>
                  </g>
                  <g>
                    <g>
                      <path
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        d="M256,0C114.84,0,0,114.842,0,256s114.84,256,256,256c141.158,0,256-114.842,256-256S397.158,0,256,0z M256,37.463    c99.191,0,183.144,66.431,209.741,157.134l-78.62,78.619v-35.949H124.878v35.949l-78.621-78.619    C72.856,103.895,156.811,37.463,256,37.463z M349.659,274.732v112.39H162.341v-112.39H349.659z M65.034,362.146    C47.484,330.697,37.463,294.5,37.463,256c0-5.581,0.212-11.114,0.626-16.591l86.789,86.789v35.949H65.034z M256,474.537    c-65.577,0-124.493-29.039-164.584-74.927h33.462v24.976h262.244V399.61h33.462C380.492,445.497,321.577,474.537,256,474.537z     M387.122,362.146v-35.949l86.789-86.789c0.413,5.477,0.626,11.01,0.626,16.591c0,38.5-10.02,74.697-27.571,106.146H387.122z"
                      />
                    </g>
                  </g>
                </svg>
              ...
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">
                    Started as an Engineering Apprentice at McKinsey and Company
                  </div>
                </div>
              </div>
              <div
                style={{ backgroundColor: "#eff3f6" }}
                className="rounded-full w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#01295c"
                ...
                >
                  <g>
                    <g>
                      <path d="M300.506,309.912L300.506,309.912v-20.5c0,0,64.6,2,95.3-29.3c0,0-44.6-12.6-36.6-93.9c8-81.2-10-152.5-75.3-146.5    c0,0-28.3-34.1-84.6-12.6c-19.3,7.4-71.2,25.9-68.6,138.5c2.6,112.5-40,113.2-40,113.2s22,32,96.6,31.3v21l56.7,165.6l56.6-165.3    L300.506,309.912z" />
            ...
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Worked as an Architect on a Digital Wallet Project
                  </div>
                </div>
              </div>
              <div
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Converted full-time to Engineer 1
                  </div>
                </div>
              </div>
              <div className="rounded-full w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="800px"
                  height="800px"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Worked as a Lead Engineer on a Data Analytics Platform
                    Project (big time growth)
                  </div>
                </div>
              </div>
              <div
                style={{ backgroundColor: "#eff3f6" }}
                className="rounded-full bg-black w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="800px"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">
                    Traveled to Munich for Oktoberfest
                  </div>
                </div>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="800px"
                  height="800px"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Designated to Engineer 2
                  </div>
                </div>
              </div>
              <div className="bg-white z-10 rounded-full w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="800px"
                  height="800px"
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Worked as an Engineer on a D2C E-Commerce Build
                  </div>
                </div>
              </div>
              <div
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                <p className="p-4 text-white rounded shadow">
                  Traveled all the way to BF Egypt
                </p>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                <svg
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">
                    Traveled to the South of France with my sister
                  </div>
                </div>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">
                    Traveled to Japan for two weeks with 6 of my best friends
                  </div>
                </div>
              </div>
              <div className="rounded-full border-white w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Worked on a Generative AI project
                  </div>
                </div>
              </div>
              <div
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Served as Tech Lead and PM for a Digitized Process Flow Web
                    App Build
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-start w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pr-8 flex flex-row-reverse items-center">
                  <div className="p-4 text-white rounded shadow">
                    Somehow convinced 10 of my people to travel to London to
                    celebrate my 26th!
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 sm:mt-0 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="flex justify-end w-full mx-auto items-center">
                <div className="w-full sm:w-1/2 sm:pl-8">
                  <div className="w-fit p-4 text-white rounded shadow">
                    Worked as an Engineer on a B2C E-Commerce Build
                  </div>
                </div>
              </div>
              <div
